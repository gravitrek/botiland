...
class CenterReview(models.Model):
    ...
    center = models.ForeignKey(TrainingCenter, on_delete=models.CASCADE, related_name='reviews')
    user = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name='center_reviews')
